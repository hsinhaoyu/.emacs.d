...
* Client/server mode
Based on [[https://www.emacswiki.org/emacs/EmacsAsDaemon][this link]], I created =~/Library/LaunchAgents/gnu.emacs.daemon.plist=, and then used =launchctl= to launch the emacs daemon.
