...
** Customized summary
  ...
  The `RX1`, `RX2`, `RX3` templates are defined in the Org-roam/Deft support section.
...
#+end_src
** Deft support
When Deft is used to display org-roam documents, RX1, RX2 and RX3 are lines that should not be displayed in file summary.
